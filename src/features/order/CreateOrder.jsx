        ...
        <div className='px-4 py-6'>
            ...
            <Form method='POST'>
                ...
                <div className='mb-5 flex gap-2 flex-col sm:flex-row sm:items-center relative'>
                    ...
                    <div className='grow'>
                        <input
                            ...
                            type="text" name="address" disabled={isLoadingAddress} required/>
                        {addressStatus === 'error' &&
                ...
                <div>
                    ...
                    <Button type='primary'
                            disabled={isSubmitting || isLoadingAddress}>{isSubmitting ? 'Placing order...' : `Order now for ${formatCurrency(totalPrice)}`}</Button>
                </div>
            </Form>
        </div>
    );
